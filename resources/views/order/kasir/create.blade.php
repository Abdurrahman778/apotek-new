...
<div class="container mt-5">
    ...
    <form action="{{route('kasir.order.store')}}" method="POST" class="card m-auto p-5 shadow-lg rounded-lg" style="background: #ffffff; border-radius: 12px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); transition: all 0.3s ease;">
        ...
        <div class="mb-4 row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control form-control-lg" name="name_costumer" id="name_costumer" value="{{old('name_costumer')}}" required style="border-radius: 10px; padding: 14px; font-size: 16px; background-color: #f1f1f1; border: 1px solid #ddd;">
            </div>
        </div>
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-primary btn-block" style="font-weight: 600; padding: 10px 0; font-size: 18px; border-radius: 10px; transition: all 0.3s ease;">
